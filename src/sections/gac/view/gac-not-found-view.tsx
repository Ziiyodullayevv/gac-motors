  ...
  return (
    <main className="min-h-screen bg-black px-6 pt-28 text-white max-md:px-5">
      <section className="mx-auto flex min-h-[70svh] max-w-[1140px] flex-col justify-center">
        <p className="mb-4 inline-block self-start border border-white/45 bg-black/30 px-4 py-1.5 text-[12px] font-semibold uppercase tracking-[0.22em] text-white max-md:text-[11px] max-md:tracking-[0.18em]">
          {t.heroGreeting}
        </p>
